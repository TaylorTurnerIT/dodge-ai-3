...
The latest completed frozen-world screen is [palette CE/BCE](http://100.100.169.122:8791/lewm-palette-probe-20260915-v1-comparison.html), with a [nearest-palette MSE control](http://100.100.169.122:8791/lewm-palette-probe-20260915-v1-quantized-comparison.html). It improves color validity but has not recovered the small moving objects. SPEC §Y defines the separate fresh RGB versus palette-input experiment; its fixed protocol and launcher are documented in [the probe kit](kit/LARGE-PROBE.md).
