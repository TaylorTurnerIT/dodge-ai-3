...
AD3.c2|Submitted job 642734 (hpc-train-c2, 14336→20000, EXTRA 5664, batch64/bf16, single A100, 2h limit); base = verified c1 run dir, digests re-checked by driver. Running on gpunode010 as of submit. Intermediates 15360…19456 + final 20000.
AD9|active|diagnostic evaluation|14336 evaluation round: AD4-protocol audit at 9216/10240/14336 (10k probe) + full survival rerun on the 14336 world (fresh probe fit, gate 0.10, same 32 scenarios, v8 policy set)|AD8|Stronger-world test of the planning plateau. Study inputs repoint 6144→14336 via protocol constants (recorded in run manifests); probe set + scenarios frozen. V13 decides MPC claims; AD.stages stop rule reads the audit ratios.
