...
AC2|pending|actual-next-latent decoder|Matched head on actual next projected z; same windows/targets/arch/init904/sample903/loss/budget as AB; oracle is empirical reference not universal bound; separately-fitted persistence secondary|AC1|Separates target/readout failure from prediction failure
...
AC1.result|lewm-dynamics-audit-20260915-v1 on live T4 via source-overlay run_dynamics_audit; 1536 validation windows × 3 offsets (0.25/0.5/0.75); frozen world aee9698c, hashes verified, torch2.11. Lpred0.03906/Lcopy0.04118 ratio0.9486; winrate0.3496; recorded-best0.1973 vs chance0.1111. Changing win0.402, static0.297. Recorded beats mean-alternative 0.0391 vs 0.0525; spread0.0184 vs move0.0169. Predictor marginally better than persistence and marginally action-sensitive; not identity, far from useful forecasting. Supports predictor-side weakness without proving H2 alone.
