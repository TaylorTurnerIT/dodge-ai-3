...
AD3.status|HPC chunk 6144→14336 complete (job 642064, exit 0, 47min A100); 8 intermediates + manifest/metrics/traces on cluster. Retrieval + 10k probe + 14336→20000 resume when user back on campus 2026-09-19. Colab stays probe/overflow only (B81).
