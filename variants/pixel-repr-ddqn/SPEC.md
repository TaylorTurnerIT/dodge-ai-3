...
AC1|pending|frozen dynamics audit|Extend evaluate_dynamics: final-action-only 9-alternative interventions, pred/copy/wrong errors, pred-vs-current distance, changing vs static windows, varied temporal offsets, per-window distributions|AB3|Build on dynamics.py; frozen model; no new collection
