...
Z2|ready|extraction|SameY palette checkpoint; same16384train/2048val native frames; final256×192 patch tokens plusCLS|Z1|Disk-backed float32; exact source/data/frame/palette hashes; unchanged encoder state; extractedCLS agrees with existing bank
Z3|pending|fitting|Three fresh shared-MLP heads: CLS broadcast, localpatch, directpixel positivecontrol;512/2048/8192|Z2|Same init904/sample903/batch32/AdamW0.001 decay0.01; raw paletteCE; frozen encoder
Z4|pending|evaluation|Native128 images, changed/percolor metrics, mean/wronglatent controls; square gallery/report|Z3|Checkpoint/hash/sampler/parameter audits; inspect movingdetails; retrieve then releaseT4
