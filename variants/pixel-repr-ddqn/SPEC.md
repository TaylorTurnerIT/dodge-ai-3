...
P6|accepted|diagnostic fitting/evaluation|Validate retained detail and open-loop dynamics|P5|Detail/temporal/prediction evidence accepted; limitations explicit; failed core blocks controllers.
P7|accepted|deferred design|Scope planning, policy and hybrid comparisons|P6|Survival objective, discrete search, DDQN/PPO fairness and controller protocols resolved; separate branch phase specs.
P8|active|deferred implementation|Implement one accepted controller branch (DDQN first)|P7|Selected branch tests/smoke pass; training remains separate.
...
V60|Standing reporting rule: every completed training or test run reports scores, loss, and prior-point deltas in the closeout; trends live in SPEC evidence rows so change-over-time is always visible. No bare completion claims.
...
Y2|complete|world fitting|1024updates/arm; retain512/1024; freshreference; batch32/history3; init42/sample43/stochastic44|Y1|Same minibatches and paired stochastic draws; original attached prediction+SIGReg0.09; AdamW5e-5 decay1e-3 clip1
Y3|complete|frozen diagnostic|Same4frames/episode seed903 banks; rawCLS only; two paletteCE heads512/2048/8192|Y2|init904/sample903/batch32/AdamW0.001 decay0.01; same native targets; world frozen; no projector calibration
Y4|complete|evaluation|Alltrain/validation; meanimage/wronglatent; square matched gallery; hashes/checkpoints; report|Y3|OneT4 worker7200s cap; retrieve+verify then release; no tuning/controllers
...
B60|2026-09-15|Inputdiagnostic artifacts kept paired lossfield names and lacked current_frame_only; shared dashboard showed missingloss/healthlabels|Afterfitting add canonical perarm loss and currentframe flag forfuture runs; displayadapter derives these from retained artifacts without rewriting them. Fixture checks RGB/palette loss mapping and finalevaluation values. Training source6905cab unchanged.

Y.result|lewm-input-study-20260915-v1 complete; training source6905cab/archive3626bbd01b7b9e944743f6886ea8cb38c7e621f815692240980803a1ea0e8c42. TeslaT4,199remote tests,1024worldupdates/arm,8192CLSCEdecoderupdates/arm. Identical18,033,690parameters/initialstate/samples/RNG. ValMSE RGB0.005606793 vs palette0.002707780 (51.7%lower); changedMSE0.141678764 vs0.141583774; changingcreamrecall0.995846% vs0.036040%. Staticpatterns clean; movingdetails not recovered. No perception/controller promotion.
Y.evidence|Resultarchived582f5153d7cf61d7e12b576f55582fccbae3f3b3da6ddb8d6b59bec231031d7;4world+6decoder checkpoints and576palette PNGs verified; samplerreplay/optimizersteps/traces/world/data/palette/framehashes pass; finalworldalias hashes identical. PeakT4allocated6.41GiB. ValidationCLS maps retrieved+SHAverified against bankmetadata; reusednativevalidationtargets SHA/indexexactmatch. T4released, noactivesessions.
Y.softprobe|Read-only CPU frozen-decoder evaluation,0updates,29.02s. Palette creamsoftmax mean changingcream0.01503,changingother0.01333,staticcream0.87858; weakmoving scores precede argmax. Not calibratedconfidence/entitylabels. Metrics/maps/script retained; source6905cab fitting artifacts unchanged.
Y.report|history/dodge/gymnasium/pixel-repr-ddqn/lewm-overnight-report-20260915.md and.html; square input/CEBCE/quantizedcontrol galleries. Final displayfix11tests/Ruff/JSsyntax pass; dashboard refreshed. Primarycheckout unchanged. Futurepatchtoken-vsCLS probe recommendation only; no additional world/controller fitting authorized by this protocol.

§Z — local spatial readout diagnosis
Z.authorization|User accepts patch-token follow-up; implementation→extraction→fitting→evaluation authorized within one7200s T4 worker. PreserveY checkpoint; no world/controller fitting.
Z1|complete|implementation|Frozen final-layer patch extraction, local decoder, matched controls, T4 runner/gallery|Y4|Luna max plus parent review; tests/Ruff/native smoke; freeze source before extraction
Z2|complete|extraction|SameY palette checkpoint; same16384train/2048val native frames; final256×192 patch tokens plusCLS|Z1|Disk-backed float32; exact source/data/frame/palette hashes; unchanged encoder state; extractedCLS agrees with existing bank
Z3|complete|fitting|Three fresh shared-MLP heads: CLS broadcast, localpatch, directpixel positivecontrol;512/2048/8192|Z2|Same init904/sample903/batch32/AdamW0.001 decay0.01; raw paletteCE; frozen encoder
Z4|complete|evaluation|Native128 images, changed/percolor metrics, mean/wronglatent controls; square gallery/report|Z3|Checkpoint/hash/sampler/parameter audits; inspect movingdetails; retrieve then releaseT4
Z.decoder|B×256×192 input plus fixedXY[-1,1] per16×16 cell; shared Linear194→256 GELU→256 GELU→192; unpatchify each192 to3×8×8 native logits. No crosspatch mixing. CLS repeats same192vector acrosscells. Pixelcontrol flattens onehot3×8×8 targetpatch; samehead/init/count. XY contains imagegeometry only.
Z.interpretation|Localdecoder is explicit diagnostic adaptation, not paperAppendixD replication. Only withinZ compares local/global access under matchedhead. Pixelcontrol is intentionally directtarget access, checks harness learnability only. Patchsuccess does not establish CLS prediction/control. Failure cannot prove information absent. No validation tuning or classweight changes.
Z.sources|references/paper/lewm-v3.md AppendixD encoder/decoder; source references/le-wm/module.py. Paper uses192dimCLS posterior decoder; spatialtokens expose precompression localfeatures without changing trained LeWM.
B61|2026-09-15|New integrationfixture exposes split pixels without ProbeBank.__len__; coverage call unnecessarily depended on split length|Use pixelarray length, same realproducer behavior; retain actualfit/evaluation/artifact integration gate. No scientificprotocol change.
B62|2026-09-15|Parent actual threehead fit catches unexpanded XY batchdimension; review also finds extra draft projection outsideZ.decoder|Expand fixedcoordinates acrossbatch; remove redundantprojection; class-major pixelpatch inverse; regressiontests cover realbatch32/locality/roundtrip beforefreeze. No remote fitting started.
Z.pooling-followup|User supplies BeyondCLS article and authorizes autonomous bounded follow-up ifCLS struggles. FinishZ first; then compare primary-source-checked mean/max/learned pooling with matchedcontrols. Preserve frozenZ source and avoid interpreting global pooling as guaranteed spatial retention.
B63|2026-09-15|Parent worker review catches checking future archivepaths before staging; packaging could fail aftersuccessful fitting|Validate actual spatial-banks sourcepaths beforearchive; use explicit source→archive mapping; verify worker packaging and realproducer→launcher schema beforefreeze. PreserveT4 until parent audit.
Z.preflight|432fulltests pass151.84s; native32CPU smoke pass. ActualY palettecheckpoint strictloads;2nativeframe extractedCLS equals oldencode_cls exactly; patches2×1×256×192. Parent reviewed fixedXY batchbroadcast, class-major roundtrip, sharedinitialization/sampling, rawCE, final-layer extraction, unchangedstate and frozen-source boundary.

Z.freeze|Final9focused extraction/launcher/actualproducer tests pass17.75s; Ruff/diffcheck clean. Commit source before oneT4 run. Frozen worldSHAaee9698cf81aa7ed1392797e1ec9cf9dd2d2cf6a06a4e3457fabd1a05121c213; retain session until parent checkpoint/PNG/sampler audit.

B64|2026-09-15|Colab proxy token expired after1hour; contents404 falsely implied missingresults; exec pruned localstate whileT4 survived|Refresh exact backend assignment binding before result retrieval; preserve kernel/session; never allocate replacement on contents404. Recovery retrieved original archive without refitting.
B65|2026-09-15|Local seeded-initialization hash audit differed across Torch2.14/local vs2.11/T4 by7.45e-9 in firstLinear; remoteCPU/CUDA hashes match frozen protocol|Audit downloaded remote-regenerated seed904 state and record runtime version; next run enforces originalcorehash on sameT4. No training defect or altered checkpoints.
Z.result|lewm-spatial-study-20260915-v1 complete fitting; sourcea337fc5/archivec12ba562abf6087a56ddb232e57f3283d9609ea7f685c057b1aa6bb3d94be97d. T4 threeheads8192; frozenworld. Val changingcream recall CLS0.5055%,patch99.9640%,pixels99.9839%; patch precision99.8286%,shadowrecall99.3938%,changedMSE0.0005070 vsCLS0.141571. Current spatial detail recoverable; no futureprediction/control claim. No randomencoder control; cannot attribute detail specifically to learned LeWM weights.
Z.retrieval|Archive1cf49a01b6851ad804ae9e22007e694c472e2fc0a24ffc9ee57e2852c9142d95; validationbank hashes verified;16CPU reconstructedPNGs matchT4 exactly. Ninecheckpoints/864palettePNGs/optimizersteps/sampleraudit passed. OriginalT4 retained for separately frozenAA follow-up.

§AA — pooling follow-up
AA.authorization|User supplies BeyondCLS article and requests autonomous work. Four bounded pooling diagnostics on same frozenZ bank/world; no world/controller fitting or collection.
AA1|x|implementation|Mean,max,learnedattention,4×4grid pooling; shared localdecoder; sourcechecked references; fresh-T4 launcher restoring retained inputs with hash gates, hash-gated recovery, separate CUDA smoke|Z4|Luna max plus parentreview; tests/Ruff; freeze beforefitting
AA2|x|input verification|Restore exact standard/spatial banks onto fresh T4 from retained bytes into immutable input root; verify world/data/frame/palette/array hashes pre-fit; no extraction except hash-gated recovery of Phase-0-missing files (stage, verify exact full digests, then promote; mismatch stops before fitting)|AA1|Same16384train/2048validation, train-derived3colorpalette; reject drift
AA.outcome.global|A global 192-value arm recovers detail → compact CLS alternative demonstrably decodable under protocol; next investigate projector preservation and predictor forecastability|AA4|Changed-region/per-color/FP metrics, matched Z milestones
AA.outcome.grid4|Only grid4 recovers detail → larger spatially structured representation promising; cannot separate extra capacity (3072 values) from spatial structure|AA4|Same reporting; no 192-organization claim
AA.outcome.none|All arms fail while matched full-patch succeeds → these compression/readout combos fail within budget; cannot prove every 192 code inadequate; no automatic extension, new arms, or predictor enlargement|AA4|Screen ends; report limitations
AA3|x|fitting|Four freshheads512/2048; frozen256×192patchinput; sharedcoreinit904/sample903/batch32/AdamW0.001 decay0.01/rawCE|AA2|One7200sT4worker; sameZcoreinitialhash; attentionadds192trainablepoolweights, recorded separately
AA4|x|evaluation|Alltrain/validation,wrongframe,meanimage; squaregallery; compare Z matched512/2048; checkpoints/sampler/hash audits|AA3|Retrieve verifiedarchive, inspect images, report limitations, releaseT4
AA.pool|Mean/max over256patchtokens→192broadcast; attention q192 initial0, weights softmax(Hq/√192), weightedmean→broadcast; grid4 mean each4×4 region of16×16tokens→16vectors, repeat within correspondingcells. FixedXY unchanged. Globalpool permutation invariant, butchannels may encodeposition. Attentionuniforminitialization equalsmean.
AA.matching|LocalPatchDecoder165056trainableparameters sameallarms; attention192extra. Registerzeroqueryallmodes foridenticalinitialstate; fixedqueryothermodes. ExistingZ default3head behavior preserved. Diagnosticloss never updatesencoder. Spatialgrid is explicitadaptation, not originalLeWM decoder.
AA.sources|Userarticle https://medium.com/@imabhi1216/beyond-cls-advanced-pooling-strategies-for-vision-transformers-8df1785ec81c; DINO eval_linear.py pinned7c446df5b9f45747937fb0d72314eb9f7b66930a uses meanpatch excludingCLS concatenatedwithCLS forclassification. Ourmean-only readout is adaptation. Learnedquery pooling follows scaleddotproductsoftmax https://arxiv.org/html/1706.03762v7; no claim exactDINO/MIL architecture.
AA.limits|Exploratory reusedvalidationsplit, oneinitialization; no untouchedtest/generalizationpromotion. Currentframeonly. No AoE/halo/death coverage claim. Mean/max/attention failure withinboundedbudget cannot prove missinginformation.
AA.status|Superseded 2026-09-18 per user: pixel decode retired after AC2 oracle bound; benchmarks are latent pred-loss curves (AD4) and action-conditional control (AD5). Screen ends without fitting; no T4 spent. AA1-AA4 and AC3 crossed, not run.

B66|2026-09-15|Parent report draft used changed_mse instead of actual changed_region_mse; initial script formatting failedRuff|Read evaluation schema, correct reportlookup and format beforefreeze. Existing artifactcontract/lint gates sufficient; no fitted outputs altered.

§AB — predicted next-frame decode view
AB.authorization|User requests current/next frame actual+decoded grid with highcontrast diffmap after Z 1:1 current decode; explicit move to future prediction. User directs one7200s T4 worker via colab CLI, not local CPU runs. FrozenY palette world; fresh broadcast readout fit on train windows only; no world/controller updates, no collection.
AB1|complete|implementation|Mid-episode window selection, teacherforced one-step ẑ features, predicted readout via shared localdecoder, persistence/wrong-latent controls, five-panel gallery with bottomright diffmap, T4 worker+launcher with proxyrefresh|Z4|Tests/Ruff; freeze commit before fitting
AB2|complete|fitting|Fresh head on ẑ train windows, one deterministic mid-episode window per train episode (all4096); 512/2048; coreinit904/sample903/batch32/AdamW0.001 decay0.01; balanced-bright MSE (0.5 cream, 0.5 other, per-frame-then-batch)|AB1|World hash unchanged before/after; window/episode provenance recorded
AB3|complete|evaluation+view|16 validation scenes: current observed/decoded, next observed/decoded, diffmap; predicted vs latent-persistence vs pixel-persistence baselines|AB2|Inspect images; changed-region/per-color metrics; limitations explicit
AB.readout|Predictor outputs projected192 ẑ; fresh LocalPatchDecoder broadcast head identical to Z CLS arm consumes ẑ. No patchtoken prediction exists; Z patch decoder serves current-frame decode only. Latent persistence = projected CLS of current frame through same head; pixel persistence = current frame copied.
AB.matching|Same core init904/sampling903/batch32/AdamW0.001 decay0.01 as Z/AA. User directed balanced-bright weighted MSE (0.5 cream/0.5 other, bright threshold0.8, per-frame-then-batch; same convention as bright-probe) instead of raw paletteCE; Z/AA arms unchanged. Train windows only; one deterministic mid-episode window per train episode (all4096). World frozen, verified by hash before/after fitting.
AB.limits|Teacherforced one-step only; no open-loop rollout or control claim. Decode quality ceiling set by predictor error, not readout capacity. Reused validation split; scenes are first16 validation episodes, not untouched test. Diffmap shows palette-class mismatch, not semantic identity.
AB.result|lewm-future-decode-20260915-v1 complete on T4; source5002e56. 2048 steps58upd/s; frozenworld+currentdecoder hashes unchanged; launcher contract audits passed. Dashboard needed embedded dataURL frames; study now emits dashboard-schema frames+diff, page shows optional diffstrip; retrieved visualizations.json regenerated locally from retrievedPNGs (roundtrip exact), audit artifacts untouched.
B67|2026-09-15|Variant dashboard renders only embedded dataURL frames, but AB views carried relative image paths; run showed empty panels while standalone comparison worked|Emit dashboard-schema frames+metadata from the study and render an optional diffstrip on the shared page. Existing runs lack diff frames so the strip stays hidden; no retrieval-contract change.

§AC — post-AB diagnosis program
AC.verdict|External review 2026-09-15: AB poor next decode does not establish H2; AA not decisive on 192 capacity. Split three questions: target representation decodability, predictor forecasting, decoder recoverability. Failures can coexist; similar decoder scores do not imply same latent information.
AC1|complete|frozen dynamics audit|Extend evaluate_dynamics: final-action-only 9-alternative interventions, pred/copy/wrong errors, pred-vs-current distance, changing vs static windows, varied temporal offsets, per-window distributions|AB3|Build on dynamics.py; frozen model; no new collection
AC2|complete|actual-next-latent decoder|Train ONLY the new actual-next projected-z head on §AB's exact midpoint training windows/targets/arch/init904/sample903/loss/2048budget; evaluate saved AB head + new head on original 16 scenes AND broader varied-offset windows with cross-head matrix and FP-aware metrics|AC1|Training-window match keeps one-variable comparison; varied training offsets would need a new protocol identity
AC3|x|AA as compression screen|Keep bounded arms+controls; grid4 is 16×192=3072 retained values not a 192 test; all-arms-fail cannot prove every 192 code inadequate (already AA.limits)|AC1|Compare vs Z matched milestones; drop 192-insufficiency decision rule
AC.sampling|window_plan midpoint62 hits frames64/65 aligned with scripted 4-decision bursts; corroborates B41 aliasing. Use several predetermined varied offsets per episode incl action-continuation and action-change transitions; report paired per-episode differences.
AC.metrics|Per-color recall is changed-region-only; class0 zero recall means missed on changed pixels not never-predicted. Copy baseline changed error 100% by construction. Add whole-image precision/recall/IoU, predicted occupancy, unchanged false positives.
AC1.result|lewm-dynamics-audit-20260915-v1 on live T4 via source-overlay run_dynamics_audit; 1536 total validation windows (512 episodes × 3 offsets 0.25/0.5/0.75); frozen world aee9698c, hashes verified, torch2.11. Lpred0.03906/Lcopy0.04118 ratio0.9486. Corrected analysis (-corrected.json, original preserved): win/loss/tie0.3496/0.6504/0.0; uniquely/tied-best0.1973/0.0 (no ties observed; 11.1% not a calibrated baseline). Higher-change win0.4023, lower-change0.3481, exact-unchanged113 windows win0.0 (persistence unbeatable by construction) unique-best0.6372. Recorded beats mean-alternative 0.0391 vs 0.0525 (25.5% reduction). RMS move 64% of transition scale: substantial but inaccurate movement, not hugging. Action-dependent signal present; reliable spatial forecasting unestablished.
AC2.result|lewm-actual-decode-20260916-v1 third T4 launch after B71 device fix; 2 heads×3 inputs matrix over 16 scenes + 1536 varied-offset windows (0.25/0.5/0.75), retrieved/verified. Matched actual-trained (primary) vs §AB predicted-trained (reference): scenes actual-input classErr 0.3021 vs 0.3128 (reference on predicted reproduces §AB 0.3142); broad 0.3120 vs 0.3247. Best cell primary_on_predicted 0.2986. Training the matched decoder on actual next-frame latents did not rescue reconstruction: predicted-vs-actual input-distribution mismatch not supported as the main explanation under this decoder/loss/budget. Shared readout limitations and weakly decodable global representations remain unresolved. Does not prove a different decoder/objective could not recover more.
AC2.controls|Wrong-latent 0.3089 and pixel-copy 0.0072 are gallery-scene controls from _evaluate_scenes only; broad evaluation stores cross-matrix cells without broad wrong-latent/pixel-copy controls. Do not present gallery controls as broad-window controls. Wrong-latent derives from the primary head primary-input condition, not per-cell shuffled controls.

B68|2026-09-15|Review request claimed predicted latent carries no forecast-specific detail and background recall 0.0 means head never predicts background|Changed-region-only recall misread as global; similar decoder scores do not imply same information. Soften to no demonstrated robust forecast advantage under protocol. Correct AB-REVIEW-REQUEST.md with addendum; protocol numbers unchanged.
B69|2026-09-15|AB window_plan reuses midpoint62 → frames64/65; external review notes alignment with scripted 4-decision bursts, corroborated by own B41 midpoint-64 aliasing|Use varied predetermined offsets per episode for AC1/AC2; keep 16 first-variant episodes as stable gallery, compute metrics over broader validation coverage. Predicted next decode classerr31.42%, changed-region56.39%, creamrecall59.65%, MSE0.04943; persistencecontrol31.91%/53.62%/71.52%; wrong-latent32.11%; pixelpersistence baseline0.72%err with0% creamrecall. Predicted≈persistence≈wrong-latent: readout carries no forecast-specific detail; weightedMSE hedges cream into background speckle. T4 retained for parent audit.

B70|2026-09-15|AC1 summary called median-split groups changing/static, reported winrate without ties, and read legacy tied-inclusive best as above-chance top-1|Rename higher/lower_pixel_change plus exact-unchanged category; separate win/loss/tie; distinguish uniquely/tied-best with declared tolerance and retain per-action errors. Corrected analysis published as separate -corrected.json from saved rows; original artifact preserved.

§AD — scaled dynamics training follow-up
AD.authorization|User2026-09-16 authorizes scaled LeWM training items 1+2 only: resume §Y palette checkpoint toward paper-scale exposure plus determined-scenario dataset expansion; item3 (planning probe) deferred, item4 (objective/architecture change) avoided. Supersedes §E P4 update caps for this follow-up only; objective/config frozen (C4); no controllers (V10).
AD.resume|Resume base history/dodge/gymnasium/pixel-repr-ddqn/lewm-input-study-20260915-v1-palette/checkpoint.pt sha aee9698cf81aa7ed1392797e1ec9cf9dd2d2cf6a06a4e3457fabd1a05121c213 (step1024, palette arm, AdamW5e-5/decay1e-3/batch32/history3/SIGReg0.09). Same code/data/sampler; V15 full-state restore (model+optimizer+sampling/torch/CUDA RNG+traces).
AD.stages|Stage1: 1024→20000 total updates in chunks with checkpoint resume; AC1/AC2 probes at first frozen checkpoint at/after 5k/10k/20k. Stage-1a (1024→3072, Colab) runs the Y2 envelope (batch32/float32); stage-1b (3072→20000, HPC single-A100 after B81) runs batch64/bf16 per R7 (batch128 exceeds T4-15GB per B79) — backend+envelope discontinuity recorded, probes compare within-envelope. Advance to paper-scale (~160k ≈ 10 epochs) only if prediction:persistence improves stage-over-stage; stop rule: ratio flat across two consecutive probe points.
AD.data|Expand large-practice corpus with determined scenarios targeting coverage gaps (near-miss, dense-crossing, high-speed, small-hazard families); same format/128 decisions; new dataset id; train/val seeds disjoint (V3); collection runs local background, no T4.
AD1|active|implementation|Resume-capable continuation trainer + determinism tests|AD.authorization|Fresh N vs (N-k)+resume-k identical checkpoint/traces; ≤32 updates/test; Ruff.
...
AD4|active|diagnostic fitting/evaluation|Latent-loss train/val trend (AC1 audit at frozen 1024/3072/5120/6144) + AC1/AC2 probes at first frozen checkpoint at/after 5k/10k/20k; advance/stop decision|AD3|Pixel decode retired as a research direction after AC2 oracle bound; benchmarks are latent pred-loss curves and action-conditional control (AD5). Common frozen readout; prediction:persistence + oracle gap reported; stop rule per AD.stages.
AD5|active|diagnostic fitting/evaluation|Action-conditional control eval: frozen survival-cost probe (train split only) + 1-step greedy MPC (9 actions, read-only world) rolled out headless on train-seed vs novel-seed scenario sets; survival frames vs scripted/random baselines. Multi-step horizon (paper-style rollout toward alive states) follows ONLY after single-action plateaus.|AD4|P6 diagnostic, not P7: no world-model updates, no policy learning, no optimization. Seeds disjoint per V3; env variants, not copies. V60 reporting on every run. Finding 2026-09-17: both training corpora (v1+scale, all invulnerable) contain ZERO deaths in 800 sampled episodes, so the probe fits on a separate mortal set (mortal-probe-20260917-v1, 160+80 eps, seeds 22000/23000, corpora untouched); world never saw death transitions — probe val AUC decides whether its latents encode danger at all.
AD4.result|lewm-audit-20260917-v1: AC1 audit at frozen 1024/3072/5120/6144 × train/val (12288/1536 windows each), T4, retrieved/verified. pred:persistence ratios train 0.9463→0.4167→0.3144→0.2580, val 0.9486→0.4187→0.3146→0.2622; win-rate 0.35→0.52 val; recorded-uniquely-best 0.197→0.688 val, zero ties. Train/val track at every point: dynamics improve with scale and generalize; no overfit gap. AD.stages stop rule not triggered (ratio still falling).
AD5.result|lewm-survival-20260918-v5 (source a46c054, frozen 6144 world, mortal-probe-20260917-v1), T4, retrieved/verified. Probe 512 steps: val_auprc 0.2038 vs prespecified gate 0.10 (~8× chance 0.028), reproduces v3 exactly → gate passed, 32-scenario × 3-policy MPC ran. MPC completed-only (15/32; 17 aborted-unknown-color on live overlay/blend colors outside practice palette, kept separate per B88): mean survival mpc 38.5 vs random 51.1 vs neutral 42.7; paired mpc−random −12.6, mpc−neutral −4.3. Latents encode danger; 1-step greedy MPC does not convert to survival. Comparison confounded by train/eval visual mismatch; abort rate must reach ~0 before any survival claim.
AD5.diagnosis|Abort color is ONLY black (0,0,0), correcting B88's overlays/blends guess. Two sources, both absent from training (0 black in 40 eps each of v1+scale): (1) screen-shake 1px edge strips — abort frame matches predecessor shifted (-1,+1) at 99.6% — transient 2-4 frames, trajectory-dependent, hence MPC aborts where neutral stays clean; (2) game-over text shadows (spawn-death scenario 25026 aborts at step 0). Probe costs discriminate across actions (9-way spread mean 1.5-2.2, std 0.8→0.13), so weak action signal is deprioritized; abort mechanism is train/eval visual mismatch.
AD6|complete|evaluation-harness fix|Mask exact-black eval-input pixels to playfield background in MPC harness; record per-episode masked counts; rerun survival comparison as v6|AD5|Narrow evidenced exception to strict palette refusal (AD5.diagnosis: shake strips + game-over text only). Any other off-palette color still aborts (fail-closed). Mask in run_episode history build; model.encode contract unchanged; baselines unaffected (never see frames). Game semantics untouched — Rust owns shake/text; this is input conditioning.
AD6.rule|Exact (0,0,0) → (41,173,255) background before policy call: shake strips expose out-of-view playfield whose training-time content is background. Masked count per episode into report rows + summary totals (V60: intervention visible, never silent). v6 expects ~0 aborts; residual aborts stay loud.
AD6.result|lewm-survival-20260918-v6 (source ec7da40): 32/32 MPC completed, 0 aborts (v5: 17 aborts); 17/32 episodes masked >0 px, 50333 masked px total. Probe val_auprc 0.2038 third reproduction. Survival means mpc 49.8 vs random 48.8 vs neutral 43.0 (baselines bit-identical to v5); paired mpc-random +1.0 95% CI [-8.5,+10.8] → inconclusive per V13, no positive policy claim; mpc-neutral +6.8 [+2.0,+11.8]. Masking fixed the harness; 1-step greedy plateaus at random. AD5's prescribed multi-step horizon now unblocked.
AD7|complete|diagnostic evaluation|H-step exhaustive MPC (H=2,3) + per-decision trace recording + dashboard replay view; v7 T4 run|AD6|1-step plateaus at random (AD6.result); multi-step is AD5's prescribed follow-on. Same 32 scenarios/seeds, same world+probe, read-only. Policies: mpc (H=1, unchanged), mpc_h2, mpc_h3, random, neutral.
AD7.planner|Exhaustive 9^H sequences, autoregressive open-loop (context slides: drop oldest latent, append predicted ẑ; actions slide equally). Sequence cost = mean probe cost over H predicted steps. First-action values V(a) = min over sequences starting with a; chosen = argmin, ties → lowest index (deterministic). H=1 path bit-identical to current _greedy_action (regression test). Batched per depth; T4-trivial.
AD7.trace|trace/<policy>/<scenario>/steps.jsonl {step, action, costs[9] or null for baselines, masked_pixels} + frame_%03d.png (observed frame BEFORE the decision). Baselines record null costs (never computed, never zero-filled). evaluate() gains trace_dir; worker tars traces with results; dashboard serves them.
AD7.dashboard|New Replay view: run/policy/scenario selectors, frame player (play/pause/step/scrub), 9-bar action-value chart with chosen highlighted (null-state for baselines), survival header. Endpoints /api/trace (steps+frame count) and /api/trace-frame (PNG bytes from disk; no data-URL inlining).
AD7.gate|No numeric prespec: V13 decides (positive 95% paired CI vs strongest predeclared baseline + scene-sensitive greedy behavior). H=2,3 each compared vs random and vs H=1.
AD7.result|lewm-survival-20260918-v7 (source 6591e35): 5 policies × 32 scenarios, 0 aborts; probe 0.2038 fourth reproduction. H=1 reproduces v6 exactly (49.8, masked 50333). Means mpc 49.8 / mpc_h2 49.4 / mpc_h3 53.2 / random 48.8 / neutral 43.0. Paired h2-random +0.6 [-7.6,+9.3]; h3-random +4.4 [-6.0,+15.4]; h3-mpc +3.4 [-9.6,+16.7] → no horizon beats random per V13; H3 is the lead (best mean, interval shifted right) but unestablished. 8133 trace files retrieved; Replay view live. Launcher publish allowlist omitted trace/ (recovered from verified archive; fixed via _publish_results + test).
AD8|complete|diagnostic evaluation|H=4 rung + sequence-cost variants (max, terminal-only) + enriched probe/rollout gap test; v8 T4 run|AD7|H3 leads but unestablished (+4.4, CI includes 0). Policies: mpc_h3 (mean reference), mpc_h4, mpc_h3_max, mpc_h3_last, random, neutral. H1/H2 measured twice on identical seeds; dropped from v8 for leanness (cross-run paired-valid by seed identity).
AD8.costs|Sequence cost modes over H probe scores: mean (legacy), max (worst predicted moment), last (terminal-only). V(a) = min over sequences per opening move in all modes; argmin + lowest-index ties. Cost mode is a planner param, recorded per policy; probe and world frozen.
AD8.gap|Paired probe-on-actual vs probe-on-predicted val AUPRC on enriched-positive windows (death-episode oversample; protocol val positives back-load to ~0 in head subsets). Same windows both arms; transfer gap = actual minus predicted. Decides predictor-vs-planner bottleneck.
AD3.status|HPC chunk 6144→14336 retrieved 2026-09-18 via relay (job 642064 dir): checkpoint.pt 929c3561…, sample c2525a90…, stochastic 8853b361…, manifest a99a7a97…. Verified: steps exact (14336/9216/10240), full optimizer+RNG state, trace digests match embedded (14336 entries; 9216/10240 prefixes match), local-6144 hash == manifest base anchor. Installed scale-resume-14336/9216/10240 with digest-consistent sliced traces. Next: 14336→20000 chunk.
AD3.c2|Job 642734 complete (37min A100): 14336→20000, loss ~0.11-0.12 end band. Retrieved + verified: step 20000, base anchor == local 14336 (929c3561…), both trace digests match (20000 entries), installed hash == CHUNK_COMPLETE line (4d8a5238…). Installed scale-resume-20000 with full triple. Intermediates 15360…19456 stay on cluster.
AD9|active|diagnostic evaluation|14336/20000 evaluation round: AD4-protocol audit at 9216/10240/14336/20000 (10k probe + stage-1 milestone) + full survival rerun on the 14336 world (fresh probe fit, gate 0.10, same 32 scenarios, v8 policy set)|AD8|Stronger-world test of the planning plateau. Study inputs repoint 6144→14336 via protocol constants (recorded in run manifests); probe set + scenarios frozen. V13 decides MPC claims; AD.stages stop rule reads the audit ratios. v9 died to Colab connection loss post-smoke (B89); v10 host-killed with launcher (B90); v11 complete, see AD9.result. Audit round complete, see AD9.audit_result.
AD8.gap_result|Paired val AUPRC, enriched 160-window slice (67% pos): probe-on-actual 0.700 vs probe-on-predicted 0.737, score corr 0.98 → no transfer loss; danger signal survives prediction. Probe/rollout mismatch closed as the MPC-plateau explanation; bottleneck is planner cost/horizon (v8 tests) or non-actionable signal.
AD8.result|lewm-survival-20260918-v8 (source 08dd0db): 6 policies × 32, 0 aborts; probe 0.2038 fifth reproduction. H3 reproduces v7 exactly (53.2). Means h3 53.2 / h3_max 52.9 / h4 49.4 / random 48.8 / neutral 43.0 / h3_last 42.3. Paired vs random: h4 +0.6 [-7.2,+9.2]; h3_max +4.1 [-6.0,+14.2]; h3_last -6.5 [-15.0,+2.1] (worse than neutral). Nothing beats random per V13: planning plateaus H1→H4 × {mean,max,last}. Terminal-only cost actively hurts. 9650 trace files auto-published (fix verified). Next: rerun on 14336 world, then learned policies (P7).
AD9.audit|Promote the bespoke v1 audit driver to colab_audit_study.py: args --checkpoints (step=path pairs), --dataset, --run-id; frozen code+dataset+checkpoints archives with sha pins; per-ckpt×split run_dynamics_audit on CUDA; per-phase retrieval (results JSONs before wholes); session retained on any mismatch. v1 procedure (splits train/validation, fractions 0.25/0.5/0.75) unchanged, only inputs vary.
AD9.result|lewm-survival-20260918-v11 (source c0cd973, frozen 14336 world 929c3561): 6 policies × 32, 0 aborts; fresh probe val_auprc 0.2368 passes gate 0.10 (up from 0.2038 on 6144). Means h3_last 61.5 / h3 56.5 / h3_max 50.3 / h4 49.8 / random 48.8 / neutral 43.0; baselines bit-identical to v8; archive/source/world/probe hashes verified. Paired vs random: h3_last +12.7 [+3.6,+21.7] → first V13-positive planning result (greedy 0 argmin mismatches over 1997 steps; scene-sensitive: 49% switch rate, median 4 winners/episode, consec cost-vector corr 0.80, W/L/T 19/10/3, frame-strip review shows hazard jinking); h3 +7.7 [-1.4,+16.8] still includes 0; h4/max flat. Terminal-only reverses worst→best across worlds: last-step prediction misleads on weak model, informs on stronger. 10298 trace files auto-published. Caveats: reused 32-scenario set, not fresh seeds; normal-approx CI. Next: AD9 audit round, then scenario-powered confirmation.
AD9.audit_result|lewm-audit-20260918-v1 (source f53afaa, T4, v1-identical procedure/dataset 683a524e; launcher defects B91/B92 fixed+tested, recovery ran identical runner/args/inputs under corrected env): val pred:persistence 9216 0.2293 / 10240 0.2308 / 14336 0.1800 / 20000 0.1322; train tracks at every point (gap <=0.020, no overfit). Full val trajectory 0.9486→0.4187→0.3146→0.2622→0.2293→0.2308→0.1800→0.1322. Stop rule NOT triggered: only 9216→10240 flat, last two intervals fall decisively; win-rate 0.52-0.55, uniquely-best 0.68-0.76. Stage-1 complete at 20000; paper-scale (~160k) authorized pending compute plan. Audit worlds match installed checkpoints byte-for-byte.
AD10|complete|diagnostic evaluation|Confirmation round: 20k world (4d8a5238) × 64 scenarios (cohort-0 original 32 + cohort-1 fresh 32: same 32 configs, seeds 26000-26015/27016-27031, labels -c1) × 4 policies (h3_last claimant, h3, random, neutral; h4/max dropped after flat on both worlds)|AD9|Fresh probe fit (same set/hyperparams/seed905), gate 0.10 prespecified; gate fail stops MPC. Primary: h3_last vs random on fresh 32 (V13 pure replication). Secondary: old-32 on 20k paired vs v11 (cross-world), h3 vs random, pooled-64 descriptive. World/probe/cohorts/policies pinned in protocol; worker reads protocol.
P6.record|P6 accepted 2026-09-18 on AD-track evidence in lieu of the original pixel-detail program (pixel decode retired after AC2 oracle bound): latent dynamics improve with scale and generalize (AD4 val 0.95→0.13, train/val track, no overfit), latents encode death (probe 0.28, ~10× chance), action-conditioned control converts to survival (AD10 h3 V13-positive on fresh+old cohorts). Limitations explicit: rendered-detail retention unproven (Z/AC2), red-sparkle corpus gap open. Owner-approved basis for P7/P8.
P7.record|P7 design approved 2026-09-18 ([CONTROLLER-DESIGN.md](kit/CONTROLLER-DESIGN.md)): frozen 20k core, 576-dim 3-frame state, unshaped survival+death reward, 4 branches (frozen h3 reference, DDQN, PPO, hybrid), 200k-decision fairness budget, V13 gates, DDQN→PPO→hybrid order. Powerup rule: powerups ON, nearest-palette projection at the live-input boundary (black keeps AD6 mask), both counts reported, abort path retained as never-trigger backstop; corpus expansion parallel. P8 opens for DDQN.
P9|active|deferred training/evaluation|Screen DDQN on frozen latents: 1 learner seed, 200k decisions, same 64 scenarios|P8|Frozen code/data/hyperparams below; V13 vs v12 random/h3 per-scenario; gate fail stops P10.
P9.protocol|World 20k frozen; fresh DuelingMLP init seed 7; epsilon 1.0→0.05 linear over 120k decisions; gamma 0.99; Adam lr 1e-3; batch 32; 1 update/decision after 5k warmup; target sync every 1000 updates; replay 100k; train envs = 64 AD10 scenarios cycled (powerups ON, projection boundary, P7 reward); greedy eval on same 64 every 20k decisions; checkpoints keep best-by-eval + final (Q/target/optimizer/counters/RNG); single T4 session, no resume (preemption relaunches).
AD10.result|lewm-survival-20260918-v12 (source b4b2ec7, frozen 20k 4d8a5238): 4 policies × 64, 1 abort; fresh probe 0.2805 passes gate (0.204→0.237→0.281 across worlds). Means h3 68.2 / h3_last 60.9 / random 50.9 / neutral 43.0; baselines bit-identical third run; hashes verified. h3 V13-positive everywhere: fresh +16.3 [+5.2,+27.4], old +18.3 [+8.7,+27.8], pooled +17.3 [+10.0,+24.6]; cross-world same-scenario +10.6 [+2.8,+18.4]; greedy 0 mismatches/4427 steps, median 6 winners/episode, W/L/T 20/10/2 fresh + 24/6/2 old. h3_last replicates on old (+11.2 [+1.4,+20.9]) and pooled (+9.2 [+1.4,+16.9]) but fresh +7.1 [-5.0,+19.2] includes 0; cross-world flat -1.5. Mechanism: stronger world (0.26→0.13) fixed mean-cost planning; terminal-only unchanged. Abort: PICO-8 index-8 red ambient sparkle from a personality-2 bomb powerup at fresh step 105 (user-identified, Rust-verified: apply_draw_side_effects emits per-frame sparkles cycling [8,9,10] for personality 2; collide_enemy maps personalities 2/3/4 to PowerupCollected); practice-mode corpora suppress organic spawns so sparkles are train-absent. Survived-so-far kept; third mismatch instance, but gameplay signal so no masking (unlike shake strips) — corpus-coverage gap instead. Caveats: old-32 reused in pooled headline; normal-approx CIs. Next: P7 learned-policy scoping; corpus gap noted for determined-scenario expansion.
...
B72|2026-09-16|Pooling driver crashed at setup: uv_binary assumed at sys.executable parent after pip install uv; Colab python3.13 installs console scripts elsewhere → FileNotFoundError before UV_SETUP_FALLBACK; two earlier smoke attempts also died on FUSE os.replace semantics (scaffolding relocation left split dirs/files builders refuse)|Invoke uv as sys.executable -m uv with try/except FileNotFoundError → pip fallback; relocate all recorded split files (incl. restored cls sidecar) and rmdir emptied split dirs before builders; compare regenerated bytes for all staged files; driver-generation test asserts setup precedes phases.

B73|2026-09-16|Pooling smoke recovery crashed in spatial branch: worker called extract_patches(bank, root) omitting the model first positional; signature drifted from spatial_probe caller and no test exercised the worker's spatial recovery path|Pass model as first arg; add signature-matching test asserting worker call site passes model/bank/root positionally per extract_patches signature.

B74|2026-09-16|Pooling smoke re-entry after partial recovery crashed: _recover_missing iterated the full protocol recovery_targets, hitting FileExistsError on standard splits already rebuilt and verified by the prior attempt|Scope recovery_targets inside _recover_missing to files actually absent; verified splits are never rebuilt; test asserts the absence filter guards the recovery body.

B75|2026-09-16|Pooling scored phase crashed creating WORK_ROOT: smoke and scored share /content as separate fresh processes and smoke had already made the work dir; exist_ok=False assumed a driver wipe the committed driver never performs|Reset the work dir inside run_scored via _reset_work_root, preserving smoke's recovery-provenance.json for the environment record; unit test covers preserve-reset-empty-default.

B76|2026-09-16|Scale chunk-1 driver crashed renaming stage/code under /content/lewm-scale-work: destination parent never created; pooling driver never hit this because all its renames target /content directly|work.mkdir before renames in scale driver; driver-generation test asserts mkdir precedes first rename.

B77|2026-09-16|Scale chunk finished 4096 updates (loss 0.248→0.17) but the T4 was reclaimed before results download; metrics mirror survived, checkpoint lost|continue_run publishes running traces at every intermediate checkpoint; launcher mirrors newest checkpoint triple every ~10min and reports newest resumable step; test requires complete triple for resume candidacy.

B78|2026-09-16|Profiler showed training data-bound (~63% of step in 32 npz decompresses; 4-slot cache useless under uniform-random sampling); uncompressed mmap cache measured SLOWER (2.9s vs 0.7s: 26GB working set thrashes disk-backed page cache) and parallel fetch first measured slower (clone construction dominated short bench)|Deploy: order-preserving parallel fetch (2 workers, per-worker dataset clones; determinism test proves bit-identity), prefetch thread hiding data behind compute, O(1) TraceAccumulator with byte-identical digests, pinned H2D, batch128/bf16 protocol params for stage-1b; keep mmap cache code opt-in only for high-RAM hosts, default off with rationale recorded.

B79|2026-09-16|Test chunk with batch128/bf16 OOMed on T4-15GB (13.9GB allocated, attention softmax the final straw) despite bf16 engaging; paper batch128 assumes bigger iron|Operational T4 ceiling is batch64; launcher restricts to {32,64} while code keeps 128 for A100; stage-1b retargeted to batch64/bf16.
...
B85|2026-09-18|First survival T4 run failed in smoke: unpinned transformers let a drifted HF ViT rename encoder submodules, strict checkpoint load rejected scale-resume-6144; local CPU smoke passed on matching versions and hid the drift|Pin transformers==4.57.6 (scale-study parity); worker records transformers_version and launcher verifies it. Smoke caught it before any scored fit; v1 session retained, relaunch under a new run id.

B86|2026-09-18|Second survival T4 run failed in smoke: synthetic all-zero encode batch is invalid for the palette-arm encoder, which rejects RGB outside its three colors; checkpoint load itself passed with the B85 pin|Smoke encodes two real recorded probe windows (palette-covered by construction) via a tested _smoke_batch helper. Wheel captured on T4 and cached locally, so the relaunch also skips the Rust build.

B87|2026-09-18|Third run passed smoke and the probe gate (val_auprc0.2038, ~8x chance) but MPC crashed: _greedy_action fed all H+1 rollout frames to a predictor capped at H, mismatching the action trace|Slice encoded history to the trailing action-trace length (training predict(encoded[:, :-1], actions) semantics); strict-shape regression test. v3 probe files retrieved as evidence; MPC reruns under a new id.

B88|2026-09-18|Fourth run reproduced the gate (0.2038 twice) but MPC died on live frames outside the 3-color palette (score/game-over overlays and sprite blends absent from practice-mode corpora); the strict palette contract refused and one crash burned the whole comparison|Record per-episode aborted-unknown-color with survived-so-far instead of failing the run; unrelated policy errors still propagate (tested). Aborts are reported separately from completed means, never silently averaged in.
B89|2026-09-18|v9 (14336 survival) passed smoke on the new world then died to colab exec-channel connection loss; VM reclaimed before scored work, nothing retrievable|Infra flake, not code: smoke green on 14336 (pipeline compatible). Relaunched same frozen inputs as v10; v9 job dir kept as failure evidence. No launcher change.
B90|2026-09-18|v10 passed smoke then died with its local shepherd: host restarted t3.service (14:20), killing the launcher mid-exec; remote driver died with the channel and the VM was reclaimed. Dashboard died in the same event|Host event, not code or Colab: setsid does not survive service-scope kills. Relaunched as v11; v10 job dir kept. Dashboard restarted; watchdog still on offer.
B91|2026-09-18|First AD9 audit launch failed at setup: shared upload() assembles parts to hardcoded /content/lewm-source.tar.gz while the new audit driver expects /content/lewm-audit.tar.gz; 108 parts uploaded, archive assert failed, nothing ran|upload() gains assemble_name (default preserves fleet behavior); audit passes lewm-audit.tar.gz; assembly-target regression test. Recovered on retained session after hash verification.
B92|2026-09-18|Recovered audit failed first invocation (10240 train): cached-wheel branch installs native extension --target wheelhouse for the driver only; runner subprocess env lacks it, so run_dynamics_audit died with No module named 'dodge_native'|Runner PYTHONPATH extends with wheelhouse in wheel branch (empty otherwise); driver-string regression test. Continued on live session with identical runner/args/inputs under corrected env.
B93|2026-09-18|First DDQN launch died in smoke in seconds: generated driver argv split across two lines without a comma, fusing run-id and --source-hash into one element (argparse rejected the hash as positional)|One complete statement per argv line; generated-argv regression test. Relaunched as v2; v1 job dir kept as failure evidence.
B94|2026-09-18|Second DDQN launch died in smoke on missing inputs: driver staged the bundle audit-style (work/inputs) while the worker reads survival-style roots (/content/lewm-ddqn-inputs), and packaged results in both places|Align to survival roots end to end (driver stages dedicated inputs root, worker self-packages); cross-file roots regression test. Relaunched as v3; v2 job dir kept.
